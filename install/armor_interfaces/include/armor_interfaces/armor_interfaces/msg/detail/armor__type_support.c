...
bool armor_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__apexs(
...
static rosidl_typesupport_introspection_c__MessageMember armor_interfaces__msg__Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[7] = {
  ...
  },
  {
    ...
    armor_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__apexs  // resize(index) function pointer
  },
  {
    "pose",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
