  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: apexs
  {
    ...
    auto array_ptr = ros_message->apexs.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: apexs
  {
    ...
    if (ros_message->apexs.data) {
      geometry_msgs__msg__Point32__Sequence__fini(&ros_message->apexs);
    }
    if (!geometry_msgs__msg__Point32__Sequence__init(&ros_message->apexs, size)) {
      fprintf(stderr, "failed to create array for field 'apexs'");
      return false;
    }
    auto array_ptr = ros_message->apexs.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name apexs
  {
    size_t array_size = ros_message->apexs.size;
    auto array_ptr = ros_message->apexs.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
