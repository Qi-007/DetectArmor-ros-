...
#define NODE_MAIN_LOGGER_NAME "armor_detect_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_detect.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ArmorDetectNode>";
